                    ...
                    <Layout className="site-layout-background" style={{padding: '24px 0'}}>
                        <Sider className="site-layout-background" width={200}
                            ...
                            >
                                ...
                                <Menu.Item key="2" icon={<MessageOutlined/>}><NavLink
                                    to="/dialogs"> Messages</NavLink></Menu.Item>
                                <Menu.Item key="3" icon={<MessageOutlined/>}><NavLink
                                    to="/chat"> Chat</NavLink></Menu.Item>
                                <Menu.Item key="4" icon={<TeamOutlined/>}><NavLink
                                    to="/users"> Users</NavLink></Menu.Item>
                                <Menu.Item key="5" icon={<AreaChartOutlined/>}><NavLink
                                    to="/news"> News</NavLink></Menu.Item>
                                <Menu.Item key="6" icon={<SoundOutlined/>}><NavLink
                                    to="/music"> Music</NavLink></Menu.Item>
                                <Menu.Item key="7" icon={<SettingOutlined/>}><NavLink
                                    to="/setting"> Setting</NavLink></Menu.Item>
                            </Menu>
                        </Sider>
